...
| 🕐 第3学时 | 算法：数组类 5 题 | M10-D1(数组篇) | 两数之和 I+II / 三数之和 / 合并有序数组 / 除自身以外数组乘积 |
...
| 🕐 第3学时 | 算法：链表 5 题 | M10-D1(链表篇) | 反转链表 I+II / 环形链表 / 合并2个有序链表 / 删除倒数第N个 |
...
| 🕐 第3学时 | 算法：栈/队列 5 题 | M10-D1 | 有效括号 / 最小栈 / 用队列实现栈 / 单调栈 / 滑动窗口最大值 |
...
| 🕐 第3学时 | 算法：二叉树遍历 5 题 | M10-D1(二叉树篇) | 前/中/后序递归+迭代 / 层序遍历 / 最大深度 |
...
| 🕐 第3学时 | 算法：二叉树递归 5 题 | M10-D1(Hot100) | 最近公共祖先 / 路径和 / 二叉树展开为链表 / 对称二叉树 / 验证二叉搜索树 |
...
| 时段 | 内容 | 具体任务 |
|---|---|---|
| 周六 | JVM 脑图整理 + 算法 | 用 Xmind/xmind 画 JVM 完整脑图；把 Hot 100 前30题再刷一遍 |
| 周日 | 并发脑图整理 + 算法 | 画并发知识脑图；Hot 100 31-50题 |
...
| 🕐 第3学时 | 算法：DFS/BFS 5 题 | M10-D1 | 岛屿数量 / 省份数量 / 二叉树右视图 / 被围绕的区域 / 课程表 |
...
| 🕐 第3学时 | 算法：回溯 5 题 | M10-D1(回溯篇) | 全排列 / 组合 / 子集 / 组合总和 / 分割回文串 |
...
| 🕐 第3学时 | 算法：二分查找 5 题 | M10-D1 | 搜索旋转排序数组 / 寻找峰值 / 在排序数组中找元素首尾 / x的平方根 / 寻找重复数 |
...
| 🕐 第3学时 | 算法：排序手写 3 题 | M10-D1 | 手写快排 / 归并排序 / 堆排序（每个都要能背出来） |
...
| 🕐 第3学时 | 算法：Hot 100 限时 4题 | 40分钟限时，模拟面试手感 |
...
| 🕐 第3学时 | 算法：DP 入门 5 题 | M10-D1(DP篇) | 斐波那契 / 爬楼梯 / 打家劫舍 / 最大子数组和 / 不同路径 |
...
| 🕐 第3学时 | 算法：DP 背包 5 题 | M10-D1 | 0-1背包 / 完全背包 / 目标和 / 零钱兑换 / 单词拆分 |
...
| 🕐 第3学时 | 算法：滑动窗口 3题 + 双指针 3题 | M10-D1 | 无重复字符最长子串 / 最小覆盖子串 / 和为s的连续正数序列 / 移动零 |
...
| 🕐 第3学时 | 算法：字符串 5 题 | M10-D1 | 最长回文子串 / 字符串相加 / 大数相乘 / 反转字符串 / 最长公共前缀 |
...
| 🕐 第3学时 | 算法：DP 进阶 5 题 | M10-D1 | 最长递增子序列 / 最长公共子序列 / 编辑距离 / 最长有效括号 / 正则匹配 |
...
| 🕐 第3学时 | 算法：堆/优先队列 3题 + 并查集 2题 | M10-D1 | 数组中的第K个最大元素 / 前K高频元素 / 数据流中位数 / 并查集模板 |
...
| 🕐 第3学时 | 算法：图 2题 + 拓扑排序 1题 | M10-D1 | 课程表 / 岛屿数量（分支限界） / 图的克隆 |
...
| 🕐 第3学时 | 算法：剑指 Offer 精选 10 题 | M10-D3 | 从剑指 Offer 中挑10道没做过的 |
...
| 🕐 第3学时 | 算法：Hot 100 前20题 | M10-D2 | 限时刷，每道10-15分钟 |
...
| 🕐 第3学时 | 算法：Hot 100 21-40题 | M10-D2 | 同上限时刷 |
...
| 🕐 第3学时 | 算法：Hot 100 41-60题 | M10-D2 | 同上 |
...
| 🕐 第3学时 | 算法：Hot 100 61-80题 | M10-D2 | 同上 |
...
| 🕐 第3学时 | 算法：Hot 100 81-100题 | M10-D2 | 完成 Hot 100 第一轮 |
...
| 🕐 第3学时 | 算法：Hot 100 第二轮 | M10-D2 | 快速过，重点看第一轮卡壳的题 |
...
| 17:00-18:00 | 算法第二轮 | Hot 100 第三遍过 |
